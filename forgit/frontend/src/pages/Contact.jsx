                    ...
                    <nav className="hidden lg:flex items-center gap-8">
                        {['О проекте', 'Шаблоны', 'Связь'].map((item) => (
                            <button 
                                key={item} 
                                onClick={() => {
                                    if (item === 'Шаблоны') navigate('/templates');
                                    else if (item === 'О проекте') navigate('/about');
                                    else if (item === 'Связь') navigate('/contact');
                                    else navigate('/');
                                }}
                                className={`text-[11px] font-black uppercase tracking-widest transition-colors ${item === 'Связь' ? 'text-emerald-600' : 'text-slate-500 hover:text-emerald-600'}`}
                            >
                                {item}
                            </button>
                        ))}
