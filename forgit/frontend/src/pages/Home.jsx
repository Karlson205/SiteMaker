                    ...
                    <div className="flex items-center gap-3">
                        {isLoggedIn ? (
                            ...
                            <div className="hidden sm:flex items-center gap-3">
                                ...
                                <button 
                                    onClick={() => navigate('/dashboard')} // Или на /profile, если создашь страницу
                                    className="p-2.5 border-2 border-slate-100 text-slate-600 hover:bg-slate-50 rounded-xl transition-all"
                                    title="Профиль"
                                >
                                    <User size={20} />
                                </button>
                            ...
                            <button 
                                ...
                                className="hidden sm:block bg-emerald-600 hover:bg-emerald-700 text-white px-6 py-2.5 rounded-xl font-bold text-sm transition-all active:scale-95"
                            >
                                ВХОД
                            </button>
                        )}
